...
| **github-contents-api-push** GitHub API 推送 | 沙箱内 git push 不通时，用 GitHub Contents API 逐文件 PUT 推送（更新带 sha / 新建省略 / 删除 DELETE），含 packed-refs 修正与远端校验 | [skills/github-contents-api-push/SKILL.md](skills/github-contents-api-push/SKILL.md) | v1 已验证 |
